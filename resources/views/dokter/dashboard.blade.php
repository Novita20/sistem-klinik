...
@section('content-header')
    <div class="p-4">
        ...
        <p class="text-gray-600">Selamat datang di halaman utama Dokter.</p>
    </div>
@endsection
    ...
    <div class="p-6">
        <div class="bg-white p-6 rounded-2xl shadow-md">
            ...
            <p class="text-gray-600">
                Anda login sebagai <strong>Dokter</strong>. Di sini Anda dapat melihat dan mengelola data pasien, hasil
